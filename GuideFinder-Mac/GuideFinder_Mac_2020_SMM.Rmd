...
```{r}
MakeDatabase<-'/Users/mellos/Documents/GitHub/Guide-Finder/GuideFinder-Mac/makeblastdb -in Complete/mutansexamplefastafile.txt -dbtype nucl -out GenomeDatabase'

RunBlast<-'/Users/mellos/Documents/GitHub/Guide-Finder/GuideFinder-Mac/blastn -task blastn-short -query BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out MatchGuides.blast'

ScrambleBlast<-'/Users/mellos/Documents/GitHub/Guide-Finder/GuideFinder-Mac/blastn -task blastn-short -query BLASTscrambles.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 11 -perc_identity .9 -out MatchScrambles.blast'
...
```{r,tidy=TRUE}
Re_RunBlast<-'/Users/mellos/Documents/GitHub/Guide-Finder/GuideFinder-Mac/blastn -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out re_MatchGuides.blast'
#If selecting option to relax off-target searches 
Re_RunBlast_Lowered<-'/Users/mellos/Documents/GitHub/Guide-Finder/GuideFinder-Mac/blastn -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 14 -out re_MatchGuides.blast'
```
