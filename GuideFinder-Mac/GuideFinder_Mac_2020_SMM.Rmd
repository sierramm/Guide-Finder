...
Note: This file is adapted from the original GuideFinder R script. 
Spoto et al. "A Universal, Genomewide GuideFinder for CRISPR/Cas9 Targeting in Microbial Genomes" (https://journals.asm.org/doi/10.1128/mSphere.00086-20)
...
# installing version 3.106 (July 2023)
...
```{r}
MakeDatabase<-'makeblastdb -in Complete/mutansexamplefastafile.txt -dbtype nucl -out GenomeDatabase'
...
```{r, tidy=TRUE}
InputGenome<- readDNAStringSet("E_coli_DH5alpha/E_coli_CP017100.fasta")
