...
Note: This file is adapted from the original GuideFinder R script to allow for designing guides with NAN or NGG PAM sites. 
...
```{r}
MakeDatabase<-'~/ncbi-blast-2.14.0+/bin/makeblastdb -in NIHLM001_concatenatedfastafile.txt -dbtype nucl -out GenomeDatabase'
...
```{r, tidy=TRUE}
InputGenome<- readDNAStringSet("NIHLM001_concatenatedfastafile.txt")
...
CoordinatesDF<-fread("NIHLM001_NewCoordinates.csv")
