...
write.csv(Parameters_Df, file = "Sepi5_NAN_Prom_Parameters.csv")
...
write.csv(CompleteGuidesList, file="Sepi5_NAN_Prom_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="Sepi5_NAN_Prom_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="Sepi5_NAN_Prom_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="Sepi5_NAN_Prom_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "Sepi5_NAN_Prom_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "Sepi5_NAN_Prom_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Sepi5_NAN_Prom_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="Sepi5_NAN_Prom_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="Sepi5_NAN_Prom_GenesWithoutGuide.csv")
...
write.csv(Genes_ReFilter,file="Sepi5_NAN_Prom_GuidesPossibleForExcludedGenes.csv")
...
#output file 
write.csv(Re_FinalGuidesSelection, file="Sepi5_NAN_Prom_GuidesUsingLowerThresholds.csv")
...
write.csv(OverallGeneInfo, file="Sepi5_NAN_Prom_WithLowered_OverallGeneInfo.csv")
```
