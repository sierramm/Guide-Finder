...
write.csv(Parameters_Df, file = "Sepi5_NAN_Parameters.csv")
...
write.csv(CompleteGuidesList, file="Sepi5_NAN_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="Sepi5_NAN_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="Sepi5_NAN_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="Sepi5_NAN_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "Sepi5_NAN_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "Sepi5_NAN_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Sepi5_NAN_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="Sepi5_NAN_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="Sepi5_NAN_GenesWithoutGuide.csv")
...
write.csv(Genes_ReFilter,file="Sepi5_NAN_GuidesPossibleForExcludedGenes.csv")
...
#output file 
write.csv(Re_FinalGuidesSelection, file="Sepi5_NAN_GuidesUsingLowerThresholds.csv")
...
write.csv(OverallGeneInfo, file="Sepi5_NAN_WithLowered_OverallGeneInfo.csv")
```
