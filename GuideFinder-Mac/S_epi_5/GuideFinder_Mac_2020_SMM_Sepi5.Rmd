...
Note: This file is adapted from the original GuideFinder R script for designing guides for S. epi 5 (NIHLM018: https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=979215) 
...
setwd ('/projects/oh-lab/sierra/Guide-Finder/GuideFinder-Mac/S_epi_5/')
```
...
```{r}
MakeDatabase<-'~/ncbi-blast-2.14.0+/bin/makeblastdb -in Sepi5concatenatedfastafile.txt -dbtype nucl -out GenomeDatabase'
...
```{r, tidy=TRUE}
InputGenome<- readDNAStringSet("Sepi5concatenatedfastafile.txt")
GenomeName <- "Staph_epi_5_NNN"
```
...
CoordinatesDF<-fread("Sepi5_NewCoordinates.csv")
...
write.csv(Parameters_Df, file = "Sepi5_PAMless_Prom_Parameters.csv")
...
write.csv(CompleteGuidesList, file="Sepi5_PAMless_Prom_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="Sepi5_PAMless_Prom_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="Sepi5_PAMless_Prom_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="Sepi5_PAMless_Prom_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "Sepi5_PAMless_Prom_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "Sepi5_PAMless_Prom_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Sepi5_PAMless_Prom_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="Sepi5_PAMless_Prom_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="Sepi5_PAMless_Prom_GenesWithoutGuide.csv")
...
write.csv(Genes_ReFilter,file="Sepi5_PAMless_Prom_GuidesPossibleForExcludedGenes.csv")
...
#output file 
write.csv(Re_FinalGuidesSelection, file="Sepi5_PAMless_Prom_GuidesUsingLowerThresholds.csv")
...
write.csv(OverallGeneInfo, file="Sepi5_PAMless_Prom_WithLowered_OverallGeneInfo.csv")
```
