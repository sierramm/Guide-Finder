...
write.csv(Parameters_Df, file = "Sepi5_PAMless_Parameters.csv")
...
write.csv(CompleteGuidesList, file="Sepi5_PAMless_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="Sepi5_PAMless_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="Sepi5_PAMless_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="Sepi5_PAMless_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "Sepi5_PAMless_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "Sepi5_PAMless_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Sepi5_PAMless_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="Sepi5_PAMless_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="Sepi5_PAMless_GenesWithoutGuide.csv")
...
write.csv(Genes_ReFilter,file="Sepi5_PAMless_GuidesPossibleForExcludedGenes.csv")
...
#output file 
write.csv(Re_FinalGuidesSelection, file="Sepi5_PAMless_GuidesUsingLowerThresholds.csv")
...
write.csv(OverallGeneInfo, file="Sepi5_PAMless_WithLowered_OverallGeneInfo.csv")
```
