...
```{r}
MakeDatabase<-'makeblastdb -in Examples/Complete/mutansexamplefastafile.txt -dbtype nucl -out GenomeDatabase'
...
```{r, tidy=TRUE}
InputGenome<- readDNAStringSet("Examples/Complete/mutansexamplefastafile.txt")
...
GenBankInfo<- readGenBank(GBAccession("AE014133.2")) 
