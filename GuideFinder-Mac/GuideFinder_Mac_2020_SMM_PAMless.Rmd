...
write.csv(Parameters_Df, file = "Sepi5_try1_Parameters.csv")
...
write.csv(GuidesHits, file="GuidesHitsBLAST.csv", row.names = F)
...
write.csv(UseableGuides, "AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Pairwise_Guides.csv")
