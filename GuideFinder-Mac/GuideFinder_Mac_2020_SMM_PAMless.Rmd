...
If not choosing to run lower thresholds, set Run_Lowered_Thresholds to FALSE and then run this chunk. 
...
write.csv(Parameters_Df, file = "Ecoli_fullgenome_Parameters.csv")
...
write.csv(CompleteGuidesList, file="E_coli_DH5alpha/ftsB_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="E_coli_DH5alpha/ftsB_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="E_coli_DH5alpha/ftsB_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="E_coli_DH5alpha/ftsB_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "E_coli_DH5alpha/ftsB_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "E_coli_DH5alpha/ftsB_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "E_coli_DH5alpha/ftsB_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="E_coli_DH5alpha/Ecoli_fullgenome_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="E_coli_DH5alpha/Ecoli_fullgenome_GenesWithoutGuide.csv")
...
write.csv(OverallGeneInfo, file="LoweredThresholdsGeneInfo.csv")
...
OverallGeneInfo<-data.frame(Parameters_Df, GeneInfoDF, 
                            GenesGainedFromLoweringThresholds) 
write.csv(OverallGeneInfo, file="E_coli_DH5alpha/Ecoli_fullgenome_OverallGeneInfo.csv")
```
