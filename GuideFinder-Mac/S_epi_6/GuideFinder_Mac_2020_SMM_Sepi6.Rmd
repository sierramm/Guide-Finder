...
Note: This file is adapted from the original GuideFinder R script for designing guides for S. epi 6 (NIHLM031: https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=979214) 
...
write.csv(Parameters_Df, file = "Sepi6_PAMless_Parameters.csv")
...
write.csv(CompleteGuidesList, file="Sepi6_PAMless_CompleteGuidesList.csv")
...
write.csv(CompleteGuidesList_Thresholds, 
          file="Sepi6_PAMless_CompleteGuidesList_Thresholds.csv", row.names = FALSE)
...
write.csv(GuidesHits, file="Sepi6_PAMless_GuidesHitsBLAST.csv", row.names = F)
...
write.csv(CompleteFilteredGuides, file="Sepi6_PAMless_CompleteFilteredGuides.csv")
...
write.csv(UseableGuides, "Sepi6_PAMless_AllUseableGuides.csv")
...
# create output file
write.csv(TopHits_GuideSelection, file = "Sepi6_PAMless_TopHits_Guides.csv")
...
# Create output file
write.csv(Pairwise_GuideSelection2, file = "Sepi6_PAMless_Pairwise_Guides.csv")
...
write.csv(GenesLost, file="Sepi6_PAMless_GenesLostInformation.csv")
...
#output to file
write.csv(GenesWithoutGuide, file="Sepi6_PAMless_GenesWithoutGuide.csv")
...
write.csv(Genes_ReFilter,file="Sepi6_PAMless_GuidesPossibleForExcludedGenes.csv")
...
#output file 
write.csv(Re_FinalGuidesSelection, file="Sepi6_PAMless_GuidesUsingLowerThresholds.csv")
...
write.csv(OverallGeneInfo, file="Sepi6_PAMless_OverallGeneInfo.csv")
```
